...
lab_min_text = Label(clock,text="Min.",font=('Times New Roman',20,"bold"),
              bg = 'red',fg = "white" )
...
lab_sec_text = Label(clock,text="Sec.",font=('Times New Roman',20,"bold"),
              bg = 'red',fg = "white" )
...
lab_mo_text = Label(clock,text="Month",font=('Times New Roman',20,"bold"),
              bg = 'red',fg = "white" )
